                            ...
                            <form method="POST" action="{{ route('add-workesEmployeeStore') }}">
                                ...
                                <div class="form-group container">
                                    ...
                                    <select name="userType" class="form-control" id="userType">
                                        ...
                                        <option value="2" {{ $employee->userType == 2 ? 'selected' : '' }}>Manager
                                        </option>
                                        <option value="3" {{ $employee->userType == 3 ? 'selected' : '' }}>Designer
                                        </option>
                                        <option value="4" {{ $employee->userType == 4 ? 'selected' : '' }}>Developer
                                        </option>
                                        <option value="5" {{ $employee->userType == 5 ? 'selected' : '' }}>QA Engineer
                                        </option>
                                        <option value="6" {{ $employee->userType == 6 ? 'selected' : '' }}>Marketing
                                        </option>
                                        <option value="0" {{ $employee->userType == 0 ? 'selected' : '' }}>Sales
                                        </option>
                                    </select>
                                </div>
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $.each(data, function(key, value) {
                                usersDropdown.append('<option value="' + value.id +
                                    '">' + value.name + '</option>');
                            });
                        },
                        error: function(xhr) {
