                            ...
                            <div class="widget-content widget-content-area">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="file" class="form-control-file" id="fileInput" name="contract[]"
                                            multiple>
                                        @error('contract')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                            ...
                                            @foreach ($fileUploads as $fileUpload)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ route('uploadsFile.details', ['id' => $fileUpload->id]) }}"
                                                            target="_blank">

                                                            <i class="fa fa-eye text-primary p-1"></i></a>
                                                        <a
                                                            href="{{ route('projectUploadsdelete', ['id' => $fileUpload->id]) }}">
                                                            <i class="fa fa-trash" style="color: red;"></i>
                                                        </a>

                                                        <a href="{{ route('projectUploadsDownloads', ['id' => $fileUpload->id]) }}"
                                                            download="upload.pdf">
