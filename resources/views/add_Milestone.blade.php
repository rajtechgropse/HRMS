        ...
        <div class="row">
            <div class="col-12">
                <div class="widget-header">
                    <br>
                    <br>
                    <h4 class="text-blue" style="margin-top: 5px;text-align: center;font-size: xxx-large;font-family: ui-sans-serif;">
                        View Milestone
                    </h4>
                    @if (session('status'))
                    ...
                    <div class="mt-3">
                        <button type="button" class="btn btn-primary btn-sm"
                            onclick="window.location='{{ route('addmilestone.idNew', ['id' => $projectId]) }}'">Add Milestone</button>
