...
<div class="layout-px-spacing">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <label for="inputZip" class="form-label">Due Date</label>
                                    ...
                                    <input type="date" class="form-control" id="inputZip"
                                    value="{{ isset($invoice['DueDate']) ? $invoice['DueDate'] : '' }}"
                                    name="due_date">
                                    @error('due_date')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">$</span>
                                    {{-- <input type="number" class="form-control" name="Amount" id="inputAmount" >x --}}
                            ...
                            <div class=" ">
                                ...
                                <div class="row p-3">
                                    ...
                                    <div class="form-check col-md-6">
                                        <input class="form-check-input" type="radio"
                                            value=" Bank USA (For International Customers Only)" name="flexRadioDefault"
                                    ...
                                    <div class="form-check col-md-6">
                                        <input class="form-check-input" type="radio" value="WesternUnion/Transferwise"
                                            name="flexRadioDefault" id="flexRadioDefault2" checked>
                                        <label class="form-check-label" for="flexRadioDefault2">
    ...
    function updateTotalPrice() {
        ...
        inputTotal.value = total.toFixed(2); // Format to two decimal places
        inputAmount.value = total.toFixed(2); // Format to two decimal places
    }
});
    </script>
