...
<<<<<<< HEAD
                        ...
                        <div class="col-xl-4 col-lg-3 col-md-6 col-sm-3 col-12 layout-spacing">
                        ...
                        <div class="col-xl-4 col-lg-3 col-md-6 col-sm-3 col-12 layout-spacing">
                            <div class="widget widget-card-four shadow-custom">
                                <div class="widget-content">
                                    <div class="w-header">
                                        <div class="w-info">
                                            <h6 class="value">Allocation Expire Current Months</h6>
                                        </div>
                                    </div>
                                    <div class="w-content p-0 mt-2">
                                        <div class="w-info p-0">
                                            <div class="d-flex align-items-baseline gap-2">
                                                <p class="value mb-0 mt-0 p-0">
                                                    <a href="{{ route('expiringDataPM') }}" id="expiringCountPM">
                                                        <span class="text-warning fs-4 fw-semibold" id="approvedCount">{{ $expiringCount }}</span>
                                                    </a>
                                                </p>
                                                @if($expiringCount <= 10) <i class="fa-solid fa-arrow-trend-down fs-5 fw-semibold text-danger"></i>
=======
                                                    <a href="{{ route('approvedDataByPm') }}" id="approvedCountLink">
                                                        <span class="text-warning fs-4 fw-semibold" id="approvedCount">{{ $approvedCount }}</span>
                                                    </a>
