            ...
            <div class="userdetails row align-items-center">
                ...
                <div class="col">
                    <div class="userdetails_main ps-4 pe-5">
                        <h2>{{ $employeeDetails->name }} <a class="edit_btn" href="#">Edit Profile</a></h2>
                    </div>
                </div>
                <div class="col-12 mt-4">
                    <form class="row form-design" action="#" method="POST">
                        ...
                        {{-- <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" value="{{ $employeeDetails->mobile_number }}" name="mobile_number" id="mobile_number" disabled>
                        </div> --}}
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" value="{{ $employeeDetails->department }}" name="department" id="department" disabled>
                        </div>
                        <div class="form-group col-md-6">
