        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.length > 0) {
                    ...
                    $('#projectDataBody').append('<tr><td colspan="7" class="text-center">No data available</td></tr>');
                }
            },
            error: function(xhr, status, error) {
                console.error('Error fetching project data:', error);
                $('#projectDataBody').empty().append('<tr><td colspan="7" class="text-center">Error fetching data</td></tr>');
            }
        });
    });
