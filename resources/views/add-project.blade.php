                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <select id="inputState" class="form-select" name="projectcompany">
                                            ...
                                            <option value="TechGropse Pvt Ltd."
                                                @if (old('projectcompany') == 'TechGropse Pvt Ltd.') selected @endif>
                                                TechGropse Pvt Ltd.
                                            </option>
                                        </select>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="projectname" class="form-control"
                                            placeholder="ProjectName" value="{{ old('projectname') }}">
                                        @error('projectname')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control" id="inputZip" name="projectbudget"
