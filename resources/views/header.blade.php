...
<head>
    ...
    <!-- JavaScript and CSS for country code selection -->
    ...
    <style>
    select#currency option[value="AFN"] { background-image: url('afn.png'); }
    select#currency option[value="ALL"] { background-image: url('all.png'); }
    /* Add similar rules for other currency options */
  </style>
</head>
                    ...
                    <div class="nav-logo">
                        <div class="nav-item theme-logo">
                            <a href="{{ route('dashboard') }}">
                                <img src="{{ asset('src/assets/img/logo.png') }}" class="navbar-logo" alt="">
                            </a>
                        </div>
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    @foreach($modules as $module)
                        ...
                        @if(Auth::user()->status == '0')
                            ...
                            @else
                            <li class="menu {{ isset($module['rolePermission']) && $module['rolePermission'] === 1 ? "" : "d-none" }}
