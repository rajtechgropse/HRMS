                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12 d-flex">
                                    ...
                                    <img src="{{ asset("images/$picture") }}" alt="Contract Image" style="width: 100px; height: 100px;object-fit: cover; margin-right: 20px;">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <p class="card-text"><small class="text-muted">Uploaded on {{ $photo['created_at']
                                            }}</small></p>
                                    @endforeach
