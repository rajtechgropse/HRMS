                        ...
                        <div class="widget-heading">
                            <form method="POST" action="{{ route('add-workesEmployeeStore') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" data-qa="input-number" type="number" pattern="[0-9]*"
                                        id="answer" min="1" max="100" name="allocationpercentage"
                                        value="" oninput="checkValue(this)">
                                        ...
                                        @foreach ($usersDetails as $index => $userDetail)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <span
                                                        class="badge bg-success">{{ $addworkesEmployees[$index]['allocationpercentage'] }}
                                                        %</span>
                                                </td>
                                                <td>
                                                    <form method="POST"
                                                        action="{{ route('deleteEmployee', ['id' => $addworkesEmployees[$index]['id']]) }}">
                                                        @csrf
                                                        @method('DELETE')
                                                    ...
                                                    <a
                                                        href="{{ route('editEmployee', ['id' => $addworkesEmployees[$index]['id']]) }}">
