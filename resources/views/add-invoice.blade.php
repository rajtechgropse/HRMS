                        ...
                        <div class="widget-content widget-content-area">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="date" class="form-control" id="inputZip" placeholder="Date"
                                        name="date">
                                    @error('date')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="date" class="form-control" id="inputZip" placeholder="Due Date"
                                        name="due_date">
                                    @error('due_date')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="inputZip"
                                            value="{{ isset($projectData['currency']) ? $projectData['currency'] : '' }}"
                                            disabled>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        <span> <input type="text" class="form-control" id="inputZip"
                                                value="{{ isset($projectData['currency']) ? $projectData['currency'] : '' }}"
                                                disabled></span>
                                ...
                                <div class="form-group mb-4 col-md-12">
                                    ...
                                    <textarea class="form-control" id="exampleFormControlTextarea1" name="Comments" placeholder="Comments"
