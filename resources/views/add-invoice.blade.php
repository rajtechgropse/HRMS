                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-6 text-end">
                                            <a href="#">
                                                ...
                                                <div class="btn btn-success  _effect--ripple waves-effect waves-light common_btn1 ">
                                                    Send
                                                    Invoice
                                                </div>
                                            </a>
                                            <!-- <button type="submit" class="btn btn-secondary  _effect--ripple waves-effect waves-light common_btn1 btn_one">Cancel
                                                Invoice
                                            </button> -->
                            <a href="{{ url()->previous() }}" class="btn btn-secondary  _effect--ripple waves-effect waves-light common_btn1 btn_one">Go Back</a>
